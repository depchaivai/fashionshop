    ...
    <body class="antialiased">
        <div class="w-screen h-screen flex items-center justify-center bg-gradient-to-r from-cyan-500 to-blue-500">
            <div id="loginform" class="bg-white shadow-sm min-w-[300px] min-h-[300px] p-7">
                <form id="authenform" action="{{route('login')}}" method="post">
                    @csrf
                    <span class="dn w-full font-bold text-2xl">đăng nhập</span>
                    ...
                    @endif
                    <button type="submit" class="dn px-2 py-1 bg-blue-500 text-white">đăng nhập</button>
                    <br>
                    <div class="flex flex-col items-end">
                        <a href="/dang-ky" class="dn text-blue-500 cursor-pointer">chưa có tài khoản?</a>
                        <span class="dn text-blue-500 cursor-pointer">quên mật khẩu</span>
                    </div>
                </form>
            </div>
        </div>       
